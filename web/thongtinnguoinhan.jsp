       ...
       <div class="center_content">
       	<div class="left_content">
        	...
        	<div class="feat_prod_box_details">
                ...
                <div class="form_subtitle">Thông Tin Người Nhận</div>
                 <%--Table thong tin nguoi dung--%>
          <form id="dangki" name="form1" method="post" action="formeditthongtinnguoinhan.jsp" >
