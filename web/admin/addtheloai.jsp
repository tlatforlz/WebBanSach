...
<body>
        <%!
            String select = "SELECT TOP 1 MaTL FROM THELOAI ORDER BY MaTL DESC";
        %>
...
<div id="wrap">
       ...
       <div class="center_content">
       	...
       	<table align="center" bgcolor="#CCFFCC"><tr ><td>
                    <strong><font  size="6" color="#3399CC">TRANG THÊM THỂ LOẠI</font></strong>
                </td></tr></table>
           <br/><br/>
           <%--onsubmit="return kiemtranhap();"--%>
<%--Table thong tin nguoi dung--%>
          <form id="form1" name="form1" method="post" action="processaddtheloai.jsp" >

<table width="571" border="0" align="center" cellpadding="0" cellspacing="0" bordercolor="#00CCFF">
  <tr>
    <td height="40" colspan="2" bgcolor="#33FF99"><div align="center" class="style1">THÊM THỂ LOẠI</div></td>
    </tr>
   <tr>
    <td width="121" height="30" bgcolor="#CCFFCC"><div align="right" class="thongtin"><strong>Mã Thể Loại:</strong></div></td>
    <td width="444" bgcolor="#66CC99"><label>
            <input name="matl" type="text" class="textbox" id="matl" value="<%=maketiep %>" size="10"/>
    </label></td>
  </tr>
  <tr>
    <td height="30" bgcolor="#CCFFCC" class="thongtin"><div align="right"><strong>Tên Thể Loại:</strong></div></td>
    <td bgcolor="#66CC99"><label>
      <input name="tentl" type="text" class="textbox" id="tentl" size="40"/>
    </label></td>
  </tr>
...
<%--Ket thuc table thong tin nguoi dung --%>           
        ...
        <br />
           ...
           <table align="center" cellspacing="20">
            <tr>
                <td>
                    <a href="edittheloai.jsp"><img src="..\images\edit.png" /></a>
                </td>
                <td>
