...
<div id="wrap">
       ...
       <div class="center_content">
       	...
       	<table align="center" bgcolor="#CCFFCC"><tr ><td>
                    <strong><font  size="6" color="#3399CC">XÓA NGƯỜI DÙNG</font></strong>
                </td></tr></table>
           <br/><br/>
<%--Table thong tin nguoi dung--%>
         <form id="form1" name="form1" method="post" action="processdeleteuser.jsp">
<center>  Chọn tên đăng nhập người dùng cần xóa: 
        <label>
    <select name="tendn">
    <%
