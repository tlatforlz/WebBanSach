...
<div id="wrap">
       ...
       <div class="center_content">
       	...
       	<table align="center" bgcolor="#CCFFCC"><tr ><td>
                    <strong><font  size="6" color="#3399CC">XÓA THỂ LOẠI</font></strong>
                </td></tr></table>
           <br/><br/>
<%--Table thong tin nguoi dung--%>
         <form id="form1" name="form1" method="post" action="processdeletetheloai.jsp">
<center>  Nhập mã thể loại cần xóa: 
        <label>
    <select name="matl">
    <%
