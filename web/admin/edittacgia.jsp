...
<div id="wrap">
       ...
       <div class="center_content">
       	...
       	<table align="center" bgcolor="#CCFFCC"><tr ><td>
                    <strong><font  size="6" color="#3399CC">SỬA THÔNG TIN TÁC GIẢ</font></strong>
                </td></tr></table>
           <br/><br/>
<%--Table thong tin nguoi dung--%>
    
         <form id="form1" name="form1" method="post" action="formedittacgia.jsp">
<center>  Chọn mã tác giả cần sửa: 
        <label>
    <select name="matg">
    <%
