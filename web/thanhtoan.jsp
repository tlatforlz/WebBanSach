                ...
                rules:
                    ...
                    messages:
                        ...
                        submitHandler: function(form){
                            if(confirm("Bạn có chắc muốn mua hàng?"))
                                {
                                    form.submit();
                                }
                        }
...
<div id="wrap">
       ...
       <div class="center_content">
          ...
          <form id="dangki" name="form1" method="post" action="processdonhang.jsp" >
<table width="300" border="0" align="center" cellpadding="0" cellspacing="0" bordercolor="#00CCFF">
  ...
  <tr>
    ...
    <td><label>
      <input name="ghichu" type="text" class="textbox" id="ghichu" />
    </label>   </td>
  </tr>
  <tr>
  	<td></td>
