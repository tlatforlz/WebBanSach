...
<body>
        ...
        <%
            ...
            String select1 = "SELECT TenDichGia FROM DICHGIA WHERE MaDichGia='"+madg+"'";
...
<%--Table thong tin nguoi dung--%>
          <form id="form1" name="form1" method="post" action="processeditdichgia.jsp" >

<table width="571" border="0" align="center" cellpadding="0" cellspacing="0" bordercolor="#00CCFF">
  <tr>
    <td height="40" colspan="2" bgcolor="#33FF99"><div align="center" class="style1">SỬA THÔNG TIN DỊCH GIẢ</div></td>
    </tr>
    <%
            if(rs!=null)
 ...
 <tr>
    ...
    <td width="444" bgcolor="#66CC99"><label>
            <input name="madg" type="text" class="textbox" id="madg" size="10" value="<%=madg %>" />
    </label></td>
  </tr>
  <tr>
    <td height="30" bgcolor="#CCFFCC" class="thongtin"><div align="right"><strong>Tên Tác Giả:</strong></div></td>
    <td bgcolor="#66CC99"><label>
            <input name="tendg" type="text" class="textbox" id="tendg" size="40" value="<%=tendg %>" />
    </label></td>
  </tr>
