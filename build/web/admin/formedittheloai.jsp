...
<body>
        ...
        <%
            ...
            String select1 = "SELECT TenTL FROM THELOAI WHERE MaTL='"+matl+"'";
...
<div id="wrap">
       ...
       <div class="center_content">
       	...
       	<table align="center" bgcolor="#CCFFCC"><tr ><td>
                    <strong><font  size="6" color="#3399CC">TRANG SỬA THÔNG TIN THỂ LOẠI</font></strong>
                </td></tr></table>
           <br/><br/>
<%--Table thong tin nguoi dung--%>
          <form id="form1" name="form1" method="post" action="processedittheloai.jsp" >

<table width="571" border="0" align="center" cellpadding="0" cellspacing="0" bordercolor="#00CCFF">
  <tr>
    <td height="40" colspan="2" bgcolor="#33FF99"><div align="center" class="style1">SỬA THÔNG TIN THỂ LOẠI</div></td>
    </tr>
    <%
            if(rs!=null)
 ...
 <tr>
    ...
    <td width="444" bgcolor="#66CC99"><label>
            <input name="matl" type="text" class="textbox" id="matl" size="10" value="<%=matl %>" />
    </label></td>
  </tr>
  <tr>
    <td height="30" bgcolor="#CCFFCC" class="thongtin"><div align="right"><strong>Tên Thể Loại:</strong></div></td>
    <td bgcolor="#66CC99"><label>
            <input name="tentl" type="text" class="textbox" id="tentl" size="40" value="<%=tentl %>" />
    </label></td>
  </tr>
