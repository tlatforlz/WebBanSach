...
<body>        	
        ...
        <%
            String select = "SELECT MaDichGia, TenDichGia FROM DICHGIA";
            rs = st.executeQuery(select);
            int i=1;
        %>
        <br/>      
        <table align="center" bgcolor="#CCFFCC"><tr ><td>
                    <strong><font  size="6" color="#3399CC">DANH SÁCH DỊCH GIẢ</font></strong>
                </td></tr></table>
    <br/><br/>
        <table align="center" border="1" border-style="solid" bordercolor="#3399CC" cellpadding="0" cellspacing="0" width="850px">
            <tr height="40">
                <th>STT</th><th>Mã Dịch Giả</th><th>Tên Dịch Giả</th>
            </tr>
        <%
            if(rs!=null)
            {
